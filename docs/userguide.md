...
1. [ファームウェアのダウンロードページ](https://github.com/object1037/vespa-zmk-module/releases/tag/v1.0)から，`vespa_firmware.zip`をダウンロードします．
